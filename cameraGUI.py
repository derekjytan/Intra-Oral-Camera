...
def vid():
    ...
    dT = datetime.datetime.now()
    strDT = dT.strftime("%d-%m-%y, %H-%M")
    camera.capture(f'home/Jeffrey/Desktop/vid{strDT}-{vidCount:03d}.h264')
    ...
    textRecording = Label(window, text = "Recoding in Progess", font = ("Georgia", 15), bg = "red")
...
zoom_text = Label(window, text = f'Zoom Level: x{zoom}', font = ("Georgia", 15), fg = "white")
zoom_text.place(x = 1640, y = hScreen * (1 / 2) + 5)

saturation_text = Label(window, text = f'Saturation: x{camSat}', font = ("Georgia", 15), fg = "white")
saturation_text.place(x = 1640, y = hScreen * (1 / 2) + 29)

bright_text = Label(window, text = f'Brightness: x{camBright}', font = ("Georgia", 15), fg = "white")
bright_text.place(x = 1640, y = hScreen * (1 / 2) + 29)

contrast_text = Label(window, text = f'Contrast: x{camContrast}', font = ("Georgia", 15), fg = "white")
contrast_text.place(x = 1640, y = hScreen * (1 / 2) + 53)

sharp_text = Label(window, text = f'Sharpness: x{camSharp}', font = ("Georgia", 15), fg = "white")
sharp_text.place(x = 1640, y = hScreen * (1 / 2) + 77)

#SQUARE FOR SETTINGS
canvas.create_rectangle(2, 2, 220, 135, fill = "white", outline = "black", width = 2)
canvas.configure(bg = "white", height = 115, width = 220)
