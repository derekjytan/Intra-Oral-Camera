...
def still():
    ...
    time.sleep(1)
    camera.capture('/home/Jeffrey/Desktop/image.jpg')
	#camera.stop_preview()
...
def vid():
    ...
    camera.start_preview()
   # GPIO.wait_for_edge(17, GPIO.FALLING)
    camera.start_recording('/home/Jeffrey/Desktop/video.h264')
    time.sleep(1)
    #GPIO.wait_for_edge(17, GPIO.FALLING)
...
text = Label(window, text=f"Zoom Level: {zoom}",font=("Georgia",15),bg="white")
