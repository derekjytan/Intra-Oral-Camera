...
def vid():
   ...
   # GPIO.wait_for_edge(17, GPIO.FALLING)
    ...
    camera.start_recording(temp_video_path, use_video_port = True)
...
#canvas.create_oval(wScreen/4 -67.5 -2, hScreen*(2/3)+165 -2 , wScreen/4 -67.5 +2, hScreen*(2/3)+165+2, width=4, fill='black')
